...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=citytour", "json.web.service.context.path=Subtipo"}, service = SubtipoService.class)
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface SubtipoService extends BaseService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SubtipoServiceUtil} to access the subtipo remote service. Add custom service methods to {@link com.liferay.symposium.citytour.service.impl.SubtipoServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
