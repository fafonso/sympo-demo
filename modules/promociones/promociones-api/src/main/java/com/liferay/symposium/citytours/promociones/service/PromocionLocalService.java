...
/**
 * Provides the local service interface for Promocion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PromocionLocalServiceUtil
...
public interface PromocionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PromocionLocalServiceUtil} to access the promocion local service. Add custom service methods to {@link com.liferay.symposium.citytours.promociones.service.impl.PromocionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Promocion createPromocion(long promocionId);
	...
	*/
	...
	public Promocion deletePromocion(long promocionId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Promocion deletePromocion(Promocion promocion);
	...
	*/
	...
	public Promocion fetchPromocion(long promocionId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Promocion fetchPromocionByUuidAndGroupId(String uuid, long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Promocion getPromocion(long promocionId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Promocion getPromocionByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Promocion> getPromocions(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Promocion> getPromocionsByUuidAndCompanyId(String uuid,
		long companyId);
