...
/**
 * Provides the local service interface for Subtipo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SubtipoLocalServiceUtil
...
public interface SubtipoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SubtipoLocalServiceUtil} to access the subtipo local service. Add custom service methods to {@link com.liferay.symposium.citytour.service.impl.SubtipoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
